...
| Q5-EDA-02 | EDA | BE+FE | Box plot helper + renderer for skewed numerics | P2 | done (BE: `818d6e6`, FE: `7bfd8cd`) |
...
| Q5-ML-05 | AutoML | BE | Lightweight hyperparameter tuning (randomized search) | P2 | done (`55cb219`) |
